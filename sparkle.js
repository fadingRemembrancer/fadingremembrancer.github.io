...
// <![CDATA[
// Does it count as stealing if I keep this tag and just upload it to my github for easier access?
// Not like the creator of the original script is still around.
var colour = "random";
var sparkles = 2500;
var x = (ox = 400);
var y = (oy = 300);
...
function sparkle() {
  ...
  setTimeout("sparkle()", 10);
}
function playMusic() {
  var music = new Audio("https://file.garden/ZcUtOGUEiTIpAPak/rogaldornno");
  music.play();
}
